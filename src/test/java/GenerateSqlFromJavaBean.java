...
/**
 * @ClassName GenerateSqlFromJavaBean
 * @Description TODO
 * @Author wuhaojie
 * @Date 2023/2/4 11:05
 */
@Slf4j
public class GenerateSqlFromJavaBean {
    //-1小写,1大写
    ...
    private static void sqlConstruction() {
        ...
        String packageName = "D:\\Learning\\Grade4_up\\毕设\\bookshare\\src\\main\\java\\com\\jie\\bookshare\\entity";
        //生成sql的文件夹
        String filePath = "D:\\Learning\\Grade4_up\\毕设\\bookshare\\src\\test\\java";
        //项目中实体类的路径
        String prefix = "com.jie.bookshare.entity.";
        String className = "";
